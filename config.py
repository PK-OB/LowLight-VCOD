...
class Config:
    ...
    train = {
        ...
        'original_data_root': '/home/sjy/paper/JED-VCOD/data/MoCA-Mask/Test', 
        ...
        'log_dir': 'logs',
        'checkpoint_name': '1029_1229_trans_testset.pth', # 체크포인트 이름 변경
    ...
    evaluate = {
        'experiment': 'proposed',
        'batch_size': 8,
        'visualization_path': 'evaluation_results/new_test_set_visualization13.png', # (저장 경로 예시)
        'checkpoint_path': 'checkpoints/1029_1229_trans_testset.pth', #           (평가할 모델 경로)
        ...
        'eval_original_data_root': '/home/sjy/paper/JED-VCOD/data/MoCA-Mask/Train',
        # ▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲
